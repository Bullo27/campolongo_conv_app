...
# Add scripts dir to path for validate_audio imports
...
def process_clip(clip_num: int, audio_path: str, vad_fn, diarizer, run_whisper_flag: bool,
                 ...
                 cmvn_window: int = DEFAULT_CMVN_WINDOW) -> dict:
...
def main():
    ...
    parser.add_argument("--b-confirm-frames", type=int, default=DEFAULT_B_CONFIRM_FRAMES,
                        help=f"Consecutive below-threshold to confirm Speaker B (default: {DEFAULT_B_CONFIRM_FRAMES})")
    parser.add_argument("--feature-mode", choices=FEATURE_MODES, default=DEFAULT_FEATURE_MODE,
                        help=f"Feature mode: static/delta/delta+dd (default: {DEFAULT_FEATURE_MODE})")
